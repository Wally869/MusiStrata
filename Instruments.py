...
# need to differentiate between percussion kit, and instruments
# Percussions must be on channel 10?
def IsPercussionTrack(instrument: str) -> bool:
    if (instrument not in INSTRUMENT_NAMES):
        if (instrument in PERCUSSION_NAMES):
            return True
