...
class InstrumentsLibraryClass(Library):
    BaseName = "InstrumentsLibrary"
    Records = None

    def GetSignalFromInstrumentName(self, instrument):
        return self.GetFromValueInField("Name", instrument)[0].Signal

    def GetInstrumentNameFromSignal(self, signal):
        return self.GetFromValueInField("Signal", signal)[0].Name

    def GetFamilyFromSignal(self, signal):
        return self.GetFromValueInField("Signal", signal)[0].Family

    def GetFamilyFromInstrumentName(self, instrument):
...
def GetSignalFromInstrument(instrument):
